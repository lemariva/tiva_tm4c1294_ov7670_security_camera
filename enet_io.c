...
//*****************************************************************************
//
// ov7670 Camera functions and variables
//
//*****************************************************************************
...
//*****************************************************************************
//
// Configure board to use the ov7670
//
//*****************************************************************************
void ConfigureBoard(void)
{
...
//*****************************************************************************
//
// Configure the UART and its pins for ov7670
//
//*****************************************************************************
void
ConfigureUART(void)
...
ConfigureI2C(void)
{
	...
	ROM_SysCtlPeripheralEnable(PORT_I2C);

    //
    // Configure GPIO Pins for I2C mode.
    //
	ROM_GPIOPinTypeI2CSCL(PORT_I2C, SCK);
	ROM_GPIOPinTypeI2C(PORT_I2C, SDA);
	//GPIOPadConfigSet(PORT_I2C, SCK | SDA, GPIO_STRENGTH_12MA , GPIO_PIN_TYPE_STD);
...
main(void)
{
    ...
    uint8_t i = 0; // camera initialization
    //
   ...
   //
   // Port/Pin configuration for ov7670 camera
   //
   ConfigureBoard();

   // UART configuration for ov7670 camera
   ConfigureUART();
